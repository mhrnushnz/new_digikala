    ...
    <header class="container-fluid border-bottom" id="desktop-main-header">
        ...
        <div class="row py-4 mx-lg-4">
            ...
            <div class="col-lg-4 d-none d-lg-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('client.auth.index') }}" class="d-flex align-items-center gap-2 text-black fs-8 border border-secondary-subtle rounded px-3 py-2">
                    @if(\Illuminate\Support\Facades\Auth::check())
                        {{auth()->user()->name}}        {{--         برای نمایش نام کاربردر دکمه حساب کار بری اول چک میکنیم اگر کاربر وجود داشت بیاد نماشو نمایش بده!        --}}
                    @else
                        <span>
              <svg
                  width="20"
