        ...
        <div class="widget-content widget-content-area">
            <form wire:submit.prevent="submit">
                ...
                <div class="form-group mb-3">
                    <input wire:model="name" type="text" name="name" class="form-control" id="sEmail" aria-describedby="emailHelp1" placeholder="شهر">
                </div>
                ...
                <div class="form-group mb-3">
                    <select wire:ignore wire:model="state_id" name="state_id" class="selectpicker" placeholder="انتخاب استان">
