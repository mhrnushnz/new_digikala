        ...
        <div class="widget-content widget-content-area">
            <form wire:submit.prevent="submit">
                ...
                <div class="form-group mb-3">
                    <input wire:model="name" type="text" name="name" class="form-control" id="sEmail" aria-describedby="emailHelp1" placeholder="روش ارسال">
                </div>
                ...
                <div class="form-group mb-3">
                    <input wire:model="price" type="text" name="price" class="form-control" id="price" aria-describedby="emailHelp1" placeholder="قیمت">
                </div>
