...
<main class="d-flex flex-column border p-4 rounded">
    ...
    <div>
        <form wire:submit.prevent="login" method="get" class="d-flex flex-column align-items-center justify-content-center gap-3 mb-4">
        ...
        <div class="row mb-4">
            <div class="col-6 d-flex justify-content-center">
                <button wire:click="redirectToProvider"
