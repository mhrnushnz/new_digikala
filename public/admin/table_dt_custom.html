...
<head>
    ...
    <title>Custom DataTables | CORK الگوی مدیریتی تمام ریسپانسیو </title>
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">جداول داده</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>سفارشی</span></li>
                            </ol>
                        </nav>
                                    ...
                                    <table id="style-2" class="table style-2  table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="shadow-none badge badge-danger">بسته شده</span></td>
                                                <td class="text-center"><a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="حذف"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle table-cancel"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg></a></td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="table-responsive mb-4 style-1">
                                    <table id="style-1" class="table style-1 table-hover non-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="checkbox-column"> 1 </td>
                                                <td class="user-name">سینا مجتهد</td>
                                                <td class="">
                                            ...
                                            <tr>
                                                <td class="checkbox-column"> 2 </td>
                                                <td class="user-name">دنیا بیهمتا</td>
                                                <td class="">
                                                    <a class="profile-img" href="javascript: void(0);">
                                                        <img src="assets/img/90x90.jpg" alt="product">
                                                    </a>
                                            ...
                                            <tr>
                                                <td class="checkbox-column"> 3 </td>
                                                <td class="user-name">ایرج دامدار</td>
                                                <td class="">
                                                    <a class="profile-img" href="javascript: void(0);">
                                                        <img src="assets/img/90x90.jpg" alt="product">
                                                    </a>
                                            ...
                                            <tr>
                                                <td class="checkbox-column"> 4 </td>
                                                <td class="user-name">مهدی رسوایی</td>
                                                <td class="">
                                                    <a class="profile-img" href="javascript: void(0);">
                                                        <img src="assets/img/90x90.jpg" alt="product">
                                                    </a>
                                            ...
                                            <tr>
                                                <td class="checkbox-column"> 5 </td>
                                                <td class="user-name">محمد شاهی</td>
                                                <td class="">
                                                    <a class="profile-img" href="javascript: void(0);">
                                                        <img src="assets/img/90x90.jpg" alt="product">
                                                    </a>
                                            ...
                                            <tr>
                                                <td class="checkbox-column"> 6 </td>
                                                <td class="user-name">امیر با مرام</td>
                                                <td class="">
                                                    <a class="profile-img" href="javascript: void(0);">
                                                        <img src="assets/img/90x90.jpg" alt="product">
                                                    </a>
                                            ...
                                            <tr>
                                                <td class="checkbox-column"> 7 </td>
                                                <td class="user-name">رضوانه پارسی</td>
                                                <td class="">
                                                    <a class="profile-img" href="javascript: void(0);">
                                                        <img src="assets/img/90x90.jpg" alt="product">
                                                    </a>
